...
5. Selecione se haverá anomalia de forma aleatória.
6. Decida aleatoriamente quem inicia a partida.
7. Os jogadores alternam posicionando suas peças na Zona Inicial.
8. O jogador que posicionou a primeira peça realiza o primeiro turno.
...
- 02. Convergência - Antes do início da partida um personagem de cada time é selecionada aleatoriamente. Após a primeira eliminação da partida, as peças marcadas trocarão imediatamente de posição. Caso uma delas tenha sido eliminada, nada acontece.
