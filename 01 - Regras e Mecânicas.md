...
3. Selecione uma condição da convergência de forma aleatória.
4. Selecione se haverá anomalia de forma aleatória.
5. Decida aleatoriamente quem inicia a partida.
6. Os jogadores alternam posicionando suas peças na Zona Inicial.
