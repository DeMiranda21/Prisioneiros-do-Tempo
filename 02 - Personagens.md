...
Cada Condutor controla uma equipe composta por cinco personagens. Cada personagem possui atributos próprios e habilidades que definem seu papel em combate.
...
#### Sementes de Cura *(Ação Especial)*
Coloque 2 sementes em casas livres dentro do alcance. Cada semente recupera 1 ponto de Vida quando
uma peça entrar em sua casa. A semente é removida após ser ativada.
...
#### Sangue pela Vida *(Ação Especial)*
...
#### Comando das Feras *(Passivo)* 
- Ao colocar o Mestre das Feras no tabuleiro, coloque uma fera em uma casa ortogonalmente adjacente
- a ele. Quando o Mestre das Feras se move, ele pode mover a fera. Quando o Mestre das Feras
- realiza um ataque, ele pode realizar um ataque com a fera. A fera não pode se mover ou atacar por
- conta própria.

#### Feras
- Fera Forte (3 vida, 3 mov, 2 atq, 1 alc)
- Fera Veloz (3 vida, 4 mov, 1 atq, 1 alc)
- Fera Resistente (7 vida, 1 mov, 1 atq, 1 alc)
...
- Bosque Vivo - Alcance: 3 - Escolha uma casa vazia. Até o início do seu próximo turno, essa casa
- não pode ser atravessada nem ocupada.
- Espírito do Lobo - Escolha um aliado dentro do alcance. Até o fim do turno, ele recebe +2 de
- Movimento.
- Ira da Natureza - Escolha uma linha do tabuleiro. Vinhas percorrem toda a linha causando 1 de
- dano em todas as peças atingidas. No próximo turno, as peças atingidas não podem se mover. O
Druida não sofre dano desta habilidade.
- Vampiric Strike - Cada vez que der ataque com o ataque básico, cura 1 vida.
- Stick Charge - Move in a straight line, pushing an enemy unit and dealing 2 dmg. The mov ends if
- the pushed unit collides with another unit or if the rider runs out of movement.
- Oven guard - Prepare a 1 tile Parry Zone around the squire until your next turn. While its
- active: reduce the firts melee attack received in this zone by 2, or negate the first projectile
- that crosses this zone.
- Blessing od hte Anti-Mage - A figure dealt damage by the witch hunter can no be affected by
